...
const stories = [
  {
    ...
    colour: "#8f1026",
    ink: "#ffffff",
    quote: "TruePrint supported the Cyber Safe Delhi event with end-to-end branding, design and customized merchandise, helping bring the event identity to life across every touchpoint in early 2025.",
  ...
  },
  {
    ...
    colour: "#0b0b0a",
    ink: "#ffffff",
    quote: "TruePrint provided complete printing and branding support for the Cybersecurity Summer Internship, managing the programme’s branded materials end to end and ensuring a consistent visual identity throughout.",
  ...
  },
  {
    ...
    colour: "#d9d8d3",
    ink: "#11110f",
    quote: "TruePrint managed the complete printing and branding requirements for Future Crime Summit 2026, supporting the event end to end with consistent, high-quality branded materials across the entire experience.",
  ...
  },
  {
    ...
    colour: "#07152f",
    ink: "#ffffff",
    quote: "TruePrint supports Binary Global with its corporate gifting and branding requirements, while also managing the design, production and execution of its branded booth presence at FutureCrime Summit.",
  ...
  },
  {
    ...
    colour: "#215a52",
    ink: "#ffffff",
    quote: "TruePrint supports 4n6 Care with its ongoing branding and printing requirements, helping maintain a consistent and professional brand presence across its materials.",
  ...
  },
  {
    ...
    colour: "#72513c",
    ink: "#ffffff",
    quote: "TruePrint has supported NetApp with select corporate gifting requirements, providing branded gifting solutions tailored to the occasion and need.",
