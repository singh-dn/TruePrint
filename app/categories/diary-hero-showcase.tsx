...
const heroThemes = {
  diaries: {
    ...
    palette: [
      ...
      "#edf3f5",
      "#dbe8ec",
      "rgba(79, 117, 157, 0.18)",
      "rgba(123, 164, 188, 0.2)",
      "21vw",
    ],
    ...
    options: [
      {
        ...
        description:
          "A structured, gift-ready diary with a tactile cover and confident brand finish.",
      ...
      },
      {
        ...
        description:
          "A versatile notebook customized around the cover, paper, layout and branding your team needs.",
      ...
      },
      {
        ...
        description:
          "Share a reference and we will explore materials, construction and branding to create the right fit.",
  ...
  "visiting-cards": {
    ...
    palette: [
      ...
      "#f2dced",
      "#e5bddf",
      "rgba(229, 189, 223, 0.58)",
      "rgba(229, 189, 223, 0.42)",
      "12vw",
    ],
    ...
    options: [
      {
        ...
        description:
          "A refined business card with a smooth tactile finish and crisp, confident branding.",
      ...
      },
      {
        ...
        description:
          "A distinctive card built around premium stock, considered typography and precise finishing.",
      ...
      },
      {
        ...
        description:
          "A statement card with elevated finishing options for brands that want to stand apart.",
  ...
  pens: {
    ...
    palette: [
      ...
      "#c9f1ed",
      "#99e1d9",
      "rgba(56, 169, 157, 0.34)",
      "rgba(153, 225, 217, 0.5)",
      "21vw",
    ],
    ...
    options: [
      {
        ...
        description:
          "A refined writing instrument with a premium weight, smooth finish and clean logo treatment.",
      ...
      },
      {
        ...
        description:
          "A practical, high-utility pen designed for offices, events, campaigns and everyday brand visibility.",
      ...
      },
      {
        ...
        description:
          "Share the look, material or mechanism you want and we will explore suitable sourcing and branding options.",
        button: "Share Your Reference",
      },
    ],
  },
    ...
    options: [
      {
        ...
        description:
          "A coordinated onboarding kit combining useful essentials, thoughtful packaging and consistent branding.",
      ...
      },
      {
        ...
        description:
          "A practical mix of branded work essentials designed around your people, budget and onboarding experience.",
      ...
      },
      {
        ...
        description:
          "Build from our product range or share references and let us source the components around your requirement.",
    ...
    options: [
      {
        ...
        description:
          "A practical everyday tech accessory with a clean form, useful capacity and considered brand placement.",
      ...
      },
      {
        ...
        description:
          "A functional branded product designed for workspaces, onboarding, gifting and events.",
      ...
      },
      {
        ...
        description:
          "Share a reference for a charger, speaker, stand, earbud, cable or accessory and we will investigate suitable options.",
        button: "Share Your Reference",
      },
    ],
  },
    ...
    options: [
      {
        ...
        description:
          "A structured work bag combining everyday utility, clean design and considered corporate branding.",
      ...
      },
      {
        ...
        description:
          "A versatile branded bag for conferences, campaigns, employee kits and high-utility giveaways.",
      ...
      },
      {
        ...
        description:
          "Share a reference for a backpack, laptop bag, duffel, tote or travel bag and we will explore suitable options.",
        button: "Share Your Reference",
      },
    ],
  },
  ...
  drinkware: {
    ...
    palette: [
      ...
      "#5fbdb9",
      "#1f5f5d",
      "rgba(28, 125, 121, 0.24)",
      "rgba(185, 239, 235, 0.38)",
      "17vw",
    ],
    ...
    options: [
      {
        ...
        description:
          "A reusable insulated bottle with a clean silhouette, practical everyday utility and refined logo placement.",
      ...
      },
      {
        ...
        description:
          "A versatile branded tumbler for desks, travel, employee kits, events and corporate gifting.",
      ...
      },
      {
        ...
        description:
          "Share the bottle, mug, flask or tumbler style you want and we will investigate suitable sourcing options.",
        button: "Share Your Reference",
      },
    ],
  },
  ...
  "t-shirts": {
    ...
    palette: [
      ...
      "#8b1221",
      "#510811",
      "rgba(255, 116, 131, 0.22)",
      "rgba(255, 198, 205, 0.32)",
      "18vw",
    ],
    ...
    options: [
      {
        ...
        description:
          "A well-fitted everyday tee with considered fabric, colour and branding for teams, events and merchandise.",
      ...
      },
      {
        ...
        description:
          "A comfortable branded T-shirt designed for events, campaigns, staff teams and high-volume requirements.",
      ...
      },
      {
        ...
        description:
          "Share a T-shirt reference, fabric direction or fit and we will explore suitable production and branding options.",
        button: "Share Your Reference",
      },
    ],
  },
...
export default function DiaryHeroShowcase({
  category = "diaries",
}: {
  category?: string;
}) {
  const theme =
    heroThemes[category as keyof typeof heroThemes] ?? heroThemes.diaries;

  const heroFrames = theme.frames;
  ...
  const move = (direction: number) => {
    setActive(
      (value) =>
        (value + direction + heroFrames.length) % heroFrames.length
    );
  };

  return (
    <section
      className="categoryDiaryHero"
      style={heroStyle}
      aria-labelledby="category-diary-hero-title"
    >
      <span className="categoryDiaryHeroWord" aria-hidden="true">
        {theme.word}
      </span>

      <div className="categoryDiaryHeroCopy">
        <p className="categoryDiaryHeroPill">
          {current.pill}
        </p>

        <h1 id="category-diary-hero-title">
          {current.title}
          <br />
        ...
        <div
          className="categoryDiaryHeroDetail"
          aria-live="polite"
        >
          <strong>
        ...
        <ArrowFillLink
          className="categoryDiaryHeroButton"
          href="/#contact"
      ...
      <div
        className="categoryDiaryStage"
        role="region"
        aria-label={`Choose a ${theme.aria} style`}
      >
        <span
          className="categoryDiaryStageGlow"
          aria-hidden="true"
        />

        <span
          className="categoryDiaryStageBase"
          aria-hidden="true"
        />
        ...
        {heroFrames.map((frame, index) => {
          ...
          const offset =
            (index - active + heroFrames.length) %
            heroFrames.length;
        ...
        <div className="categoryDiaryStageControls">
          <button
            type="button"
            onClick={() => move(-1)}
            aria-label={`Previous ${theme.aria}`}
          >
            <Arrow reverse />
          </button>
